...
import './App.css';
import p1 from './assets/img/12.jpg';
import p2 from './assets/img/11.jpg';
import p3 from './assets/img/13.jpg';

function App() {
  const portfolioLinks = [
    {
      title: 'Banquets',
      caption: 'A place to create beautiful memories',
      url:'../assets/img/4.jpg'
    },
    {
      title: 'Conferences',
      caption: 'The right meeting space',
      url:'../assets/img/4.jpg'
    },
    {
      title: 'Rooms',
      caption: 'A Comfortable welcome stay',
      url:'../assets/img/4.jpg'
    },
    {
      title: 'Dinning',
      caption: 'Delight your taste buds',
      url:'../assets/img/4.jpg',
    },
    {
  ...
  <header className="masthead">
    <div className="container">
      <div className="intro-text">
        ...
        <div className="intro-heading text-uppercase">Vinora Hotel </div>
      ...
      <div className="row">
        <div className="col-sm-4">
          <div className="team-member">
            <img className="mx-auto rounded-circle" src={p1} alt=""/>
            <h4>Kay Garland</h4>
        ...
        <div className="col-sm-4">
          <div className="team-member">
            <img className="mx-auto rounded-circle" src={p3} alt=""/>
            <h4>Larry Parker</h4>
            <p className="text-muted">Assistant General Manager</p>
            <ul className="list-inline social-buttons">
              <li className="list-inline-item">
                <a href="#something">
                  <i className="fa fa-twitter"></i>
        ...
        <div className="col-sm-4">
          <div className="team-member">
            <img className="mx-auto rounded-circle" src={p2} alt=""/>
    ...
    <div className="container">
      <div className="row align-items-center">
        <div className="col-md-4">
          <span className="copyright">Copyright &copy; Vinora 2021</span>
        </div>
        <div className="col-md-4">
          <ul className="list-inline social-buttons">
            <li className="list-inline-item">
